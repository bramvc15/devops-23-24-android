...
fun generateFlights(): List<Flight> = buildList {
    ...
    currentMonth.atDay(17).also { date ->
        add(
            Flight(
                date.atTime(14, 0),
                Airport("Guillaume De Craene", "LOS"),
                R.color.purple_700,
            ),
        )
        add(
            Flight(
                date.atTime(21, 30),
                Airport("Guillaume De Craene", "ENU"),
                R.color.purple_700,
            ),
        )
    }
    ...
    currentMonth.atDay(22).also { date ->
        add(
            Flight(
                date.atTime(13, 20),
                Airport("Guillaume De Craene", "IBA"),
                R.color.purple_700,
            ),
        )
        add(
            Flight(
                date.atTime(17, 40),
                Airport("Guillaume De Craene", "SKO"),
                R.color.black,
            ),
        )
    }
    currentMonth.atDay(3).also { date ->
        add(
            Flight(
                date.atTime(19, 0),
                Airport("Guillaume De Craene", "MDI"),
                R.color.purple_700,
            ),
        )
    }
    ...
    currentMonth.atDay(23).also { date ->
        add(
            Flight(
                date.atTime(20, 0),
                Airport("Guillaume De Craene", "MDI"),
    ...
    currentMonth.atDay(4).also { date ->
        add(
            Flight(
                date.atTime(20, 0),
                Airport("Makurdi", "MDI"),
